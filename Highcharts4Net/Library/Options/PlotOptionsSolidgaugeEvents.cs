...
{
	public class PlotOptionsSolidgaugeEvents
	{
		/// <summary>
		...
		public LiteralString AfterAnimate { get; set; }
		...
		public LiteralString CheckboxClick { get; set; }
		...
		public LiteralString Hide { get; set; }
		...
		public LiteralString LegendItemClick { get; set; }
		...
		public LiteralString Show { get; set; }

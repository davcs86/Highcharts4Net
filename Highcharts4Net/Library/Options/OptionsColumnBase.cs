...
{
	public class OptionsColumnBase
    {
		/// <summary>
		...
		/// Default: 0.2
		/// </summary>
		public HighchartsDataPoint? GroupPadding { get; set; }
		...
		/// Default: 0
		/// </summary>
		public HighchartsDataPoint? MinPointLength { get; set; }
        ...
        /// </summary>
        public PlotOptionsColumnZone[] Zones { get; set; }
	}

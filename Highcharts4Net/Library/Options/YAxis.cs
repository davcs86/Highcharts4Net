...
{
	/// <summary>
	/// <p>The Y axis or value axis. Normally this is the vertical axis, though if the  chart is inverted this is the horizontal axis. In case of multiple axes, the yAxis node is an array of configuration objects.</p> <p>See <a class='internal' href='#axis.object'>the Axis object</a> for programmatic access to the axis.</p>
	/// </summary>
	public class YAxis
	{
		/// <summary>
		...
		/// </summary>
		public HighchartsDataPoint? Ceiling { get; set; }
		...
		/// Default: null
		/// </summary>
		public HighchartsDataPoint? Floor { get; set; }
		...
		/// Default: 1
		/// </summary>
		public HighchartsDataPoint? GridLineWidth { get; set; }

		/// <summary>
		/// The Z index of the grid lines.
		/// Default: 1
		/// </summary>
		public HighchartsDataPoint? GridZIndex { get; set; }
		...
		/// </summary>
		public HighchartsDataPoint? LinkedTo { get; set; }
		...
		/// </summary>
		public HighchartsDataPoint? Max { get; set; }
		...
		/// Default: 0.05
		/// </summary>
		public HighchartsDataPoint? MaxPadding { get; set; }

		[Obsolete("Deprecated. Renamed to <code>minRange</code> as of Highcharts 2.2.")]
		public HighchartsDataPoint? MaxZoom { get; set; }
		...
		/// </summary>
		public HighchartsDataPoint? Min { get; set; }
		...
		/// Default: 0.05
		/// </summary>
		public HighchartsDataPoint? MinPadding { get; set; }
		...
		/// </summary>
		public HighchartsDataPoint? MinRange { get; set; }
		...
		/// </summary>
		public HighchartsDataPoint? MinTickInterval { get; set; }
		...
		/// Default: 1
		/// </summary>
		public HighchartsDataPoint? MinorGridLineWidth { get; set; }
		...
		/// </summary>
		public HighchartsDataPoint? MinorTickInterval { get; set; }

		/// <summary>
		/// The pixel length of the minor tick marks.
		/// Default: 2
		/// </summary>
		public HighchartsDataPoint? MinorTickLength { get; set; }
		...
		/// Default: 0
		/// </summary>
		public HighchartsDataPoint? MinorTickWidth { get; set; }
        ...
        /// </summary>
        public HighchartsDataPoint? TickAmount { get; set; }
		...
		/// </summary>
		public HighchartsDataPoint? TickInterval { get; set; }

		/// <summary>
		/// The pixel length of the main tick marks.
		/// Default: 10
		/// </summary>
		public HighchartsDataPoint? TickLength { get; set; }
		...
		/// </summary>
		public HighchartsDataPoint? TickPixelInterval { get; set; }
		...
		/// </summary>
		public HighchartsDataPoint?[] TickPositions { get; set; }

		/// <summary>
		/// The pixel width of the major tick marks.
		/// Default: 0
		/// </summary>
		public HighchartsDataPoint? TickWidth { get; set; }

...
namespace Highcharts4Net.Library.Options
{
	...
	/// </summary>
	public class PlotOptionsSolidgaugeStatesHover
	{
		/// <summary>
		...
		/// </summary>
		public PlotOptionsSolidgaugeStatesHoverHalo Halo { get; set; }
		...
		public PlotOptionsSolidgaugeStatesHoverMarker Marker { get; set; }

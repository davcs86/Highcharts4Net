...
{
	abstract public class OptionsAreaBase
	{
		/// <summary>
		...
		/// Default: 0.75
		/// </summary>
		public HighchartsDataPoint? FillOpacity { get; set; }
        ...
        /// <p>It can be combined with <em>pointIntervalUnit</em> to draw irregular intervals.</p>
		/// Default: 1
		/// </summary>
        ...
        /// </summary>
        public PlotOptionsAreaZone[] Zones { get; set; }
